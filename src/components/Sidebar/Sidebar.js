        ...
        <ul className="sidebar__times">
          ...
          <li
            className={`sidebar-upcoming ${
              active === "upcoming" ? "active" : undefined
            }`}
            onClick={() => {
              setActive("upcoming");
              // setSelectedProject(null)
        ...
        <div className="sidebar__options">
          <div className="sidebar-projects">
            <div className="sidebar-projects-icons">
              <span className="open-icon" onClick={handleOpenProjects}>
                {openProjects ? <AiOutlineDown /> : <AiOutlineRight />}
              </span>
              <span className="sidebar__option-label">Projects</span>
          ...
          <div className="sidebar-labels">
            <span className="open-icon" onClick={handleOpenLabels}>
              {openLabels ? <AiOutlineDown /> : <AiOutlineRight />}
            </span>
            <span className="sidebar__option-label">Labels</span>
          ...
          <div className="sidebar-filters">
            <span className="open-icon" onClick={handleOpenFilters}>
              {openFilters ? <AiOutlineDown /> : <AiOutlineRight />}
            </span>
            <span className="sidebar__option-label">Filters</span>
